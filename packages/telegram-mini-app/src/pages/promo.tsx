...
const promoMessages = [
  ...
  `Malwarebytes Browser Guard is also free browser extension available for Chrome, Safari, Firefox and Edge. <a class="text-blue-600 underline" href='https://www.malwarebytes.com/browserguard'>Get protected for free</a>`,
